...
int main()
{
    ...
    // ----------------这里需要填绝对路径--------------------
    Shader* ourShader = new Shader("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-变换/texture_shader.vs", "/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-变换/texture_shader.fs");
    ...
    unsigned char* data = stbi_load("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-变换/container.jpg", &width, &height, &nrChannels, 0);
    if (data) {
    ...
    data  =  stbi_load("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-变换/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data) {
...
//
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 trans;
#pragma 先位移后旋转
        trans = glm::translate(trans, glm::vec3(sin((float)glfwGetTime())*0.5f, -cos((float)glfwGetTime())*0.5f, 0.0f));
...
#pragma 第二个三角形
        ...
        transform = glm::translate(transform, glm::vec3(-cos(glfwGetTime())*0.5f, scaleAmount*0.5f, 0.0f));
