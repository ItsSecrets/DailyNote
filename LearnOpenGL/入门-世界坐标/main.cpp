...
int main()
{
    ...
    // ----------------这里需要填绝对路径--------------------
    Shader* ourShader = new Shader("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-世界坐标/texture_shader.vs", "/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-世界坐标/texture_shader.fs");
    ...
    unsigned char* data = stbi_load("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-世界坐标/container.jpg", &width, &height, &nrChannels, 0);
    if (data) {
    ...
    data  =  stbi_load("/Users/zwf/Documents/my_space/DailyNote/LearnOpenGL/入门-世界坐标/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data) {
